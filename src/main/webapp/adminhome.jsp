...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="reportsDropdown">
                            <a class="dropdown-item" href="nutrientDeficiencyReport">Nutrient Deficiency Report</a>
                            <a class="dropdown-item" href="userTrendsReport">User Trends Report</a>
                        </div>
                    </li>
    ...
    <div class="container mt-5">
        ...
        <p class="text-center">You have successfully logged in. You can manage users, nutritionists, and generate reports from here.</p>
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <a href="nutrientDeficiencyReport" class="btn btn-warning btn-block">Generate Nutrient Deficiency Report</a>
            </div>
            <div class="col-md-6">
                <a href="userTrendsReport" class="btn btn-warning btn-block">Generate User Trends Report</a>
            </div>
        </div>
    </div>
