...
//    }
 ...
 // Endpoint to view the Nutrient Deficiency Report
    @GetMapping("nutrientDeficiencyReport")
    public String generateNutrientDeficiencyReport(Model model) {
        List<String> report = userService.generateNutrientDeficiencyReport();
        model.addAttribute("report", report);
        return "nutrientDeficiencyReport";  // JSP page to display the report
    }

    // Endpoint to view the User Trends Report
    @GetMapping("userTrendsReport")
    public String generateUserTrendsReport(Model model) {
        List<String> report = userService.generateUserTrendsReport();
        model.addAttribute("report", report);
        return "userTrendsReport";  // JSP page to display the report
    }
